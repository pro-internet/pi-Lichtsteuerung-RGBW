<?
    ...
    class LichtsteuerungRGB extends IPSModule {
        ...
        public function Create() {
            ...
            if(@$this->RegisterPropertyString("LichterW") !== false){
                $this->RegisterPropertyString("LichterW","");
            }
        ...
        public function ApplyChanges() {
            ...
            $deviceList = json_decode($this->ReadPropertyString("LichterW"));
            //print_r($deviceList);
            ...
            if (is_array($deviceList) || is_object($deviceList)){
                foreach($deviceList as $i => $list){
                    ...
                    $isEmpty = @IPS_GetObjectIDByIdent("W", $insID);
                    if(!empty($isEmpty)){
        ...
        public function eventTriggerOnChange($InstanceID){
            ...
            $getList =  IPS_GetProperty($parent, "LichterW");
       ...
       protected function CreateEventTrigger($triggerID){
            ...
            // Set Script            
            IPS_SetEventScript($eid, "DMXW_eventTriggerOnChange(". $Instance .", ". $triggerID .");");
            // OnUpdate für Variable 12345
            IPS_SetEventTrigger($eid, 0, $triggerID);            
            IPS_SetEventActive($eid, true);
