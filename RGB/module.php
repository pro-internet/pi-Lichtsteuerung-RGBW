<?
    ...
    class LichtsteuerungRGB extends IPSModule {
        ...
        public function Create() {
            ...
            if(@$this->RegisterPropertyString("LichterRGB") !== false){
                $this->RegisterPropertyString("LichterRGB","");
            }
        ...
        public function ApplyChanges() {
            ...
            $deviceList = json_decode($this->ReadPropertyString("LichterRGB"));
            //print_r($deviceList);
        ...
        public function eventTriggerOnChange($InstanceID){
            ...
            $getList =  IPS_GetProperty($parent, "LichterRGB");
       ...
       protected function CreateEventOn($insID, $triggerID, $hauptInstanz){
           ...
           // Set Script 
           IPS_SetEventScript($eid, "DMXRGB_refresh(". $hauptInstanz .", ". $hauptInstanz .", ". $insID .", ". $triggerID .");");
       ...
       protected function CreateEventTrigger($triggerID){
            ...
            // Set Script            
            IPS_SetEventScript($eid, "DMXRGB_eventTriggerOnChange(". $Instance .", ". $triggerID .");");
            // OnUpdate für Variable 12345
            IPS_SetEventTrigger($eid, 0, $triggerID);            
            IPS_SetEventActive($eid, true);
